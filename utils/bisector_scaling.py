def soln_1(p1: list, p2: list, p3: list, d) -> list:
    ...
    x3, y3 = p3
    x = (
        (x1 * y2 - x2 * y1) * ((x2 - x3) ** 2 + (y2 - y3) ** 2) ** (1 / 2)
        - (x2 * y3 - x3 * y2) * ((x1 - x2) ** 2 + (y1 - y2) ** 2) ** (1 / 2)
    ) / (
        ((x1 - x2) ** 2 + (y1 - y2) ** 2) ** (1 / 2) * (y2 - y3)
        - ((x2 - x3) ** 2 + (y2 - y3) ** 2) ** (1 / 2) * (y1 - y2)
    ) + (
        (
            ((x1 - x2) ** 2 + (y1 - y2) ** 2) ** (1 / 2) * (x2 - x3)
            - ((x2 - x3) ** 2 + (y2 - y3) ** 2) ** (1 / 2) * (x1 - x2)
        )
        * (
            2 * y2
            - 2 ** (1 / 2)
            ...
            * (
                (
                    ...
                    + (x2 - x3) ** 4 * (y1 - y2) ** 4
                    + 4 * (y1 - y2) ** 4 * (y2 - y3) ** 4
                    + (x1 - x2) ** 2 * (x2 - x3) ** 4 * (y1 - y2) ** 2
                    + (x1 - x2) ** 4 * (x2 - x3) ** 2 * (y2 - y3) ** 2
                    + 5 * (x1 - x2) ** 2 * (y1 - y2) ** 2 * (y2 - y3) ** 4
                    + 5 * (x2 - x3) ** 2 * (y1 - y2) ** 4 * (y2 - y3) ** 2
                    - 4
                    * ((x1 - x2) ** 2 + (y1 - y2) ** 2) ** (1 / 2)
                    * ((x2 - x3) ** 2 + (y2 - y3) ** 2) ** (1 / 2)
                    * (y1 - y2) ** 3
                    ...
                    * (y1 - y2) ** 2
                    * (y2 - y3) ** 2
                    + 2 * (x1 - x2) ** 3 * (x2 - x3) ** 3 * (y1 - y2) * (y2 - y3)
                    + 2 * (x1 - x2) ** 3 * (x2 - x3) * (y1 - y2) * (y2 - y3) ** 3
                    + 2 * (x1 - x2) * (x2 - x3) ** 3 * (y1 - y2) ** 3 * (y2 - y3)
                    + 2 * (x1 - x2) * (x2 - x3) * (y1 - y2) ** 3 * (y2 - y3) ** 3
                    - ((x1 - x2) ** 2 + (y1 - y2) ** 2) ** (1 / 2)
                    * ((x2 - x3) ** 2 + (y2 - y3) ** 2) ** (1 / 2)
                    * (x1 - x2)
                    * (x2 - x3) ** 3
...
if __name__ == "__main__":
    ...
    print(
        closer(opt_1, opt_2, p1)
    )  # output the point closer to point 1, as that is the interior solution.
